...
function ma57_default_control_s(control)
    @ccall libhsl.ma57_default_control_s(control::Ptr{ma57_control{Float32}})::Cvoid
end
...
function ma57_analyse_s(n, ne, row, col, factors, control, ainfo, perm)
    @ccall libhsl.ma57_analyse_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                 factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float32}},
                                 ainfo::Ptr{ma57_ainfo{Float32}}, perm::Ptr{Cint})::Cvoid
end
...
function ma57_factorize_s(n, ne, row, col, val, factors, control, finfo)
    @ccall libhsl.ma57_factorize_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                   ...
                                   control::Ptr{ma57_control{Float32}},
                                   finfo::Ptr{ma57_finfo{Float32}})::Cvoid
end
...
function ma57_solve_s(n, ne, row, col, val, factors, nrhs, x, control, sinfo, rhs, iter,
                      cond)
    @ccall libhsl.ma57_solve_s(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                               val::Ptr{Float32}, factors::Ptr{Ptr{Cvoid}},
                               nrhs::Cint, x::Ptr{Float32},
                               control::Ptr{ma57_control{Float32}}, sinfo::Ptr{ma57_sinfo{Float32}},
                               rhs::Ptr{Float32}, iter::Cint, cond::Cint)::Cvoid
end

function ma57_finalize_s(factors, control, info)
    @ccall libhsl.ma57_finalize_s(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float32}},
                                  info::Ptr{Cint})::Cvoid
end

function ma57_enquire_perm_s(control, factors, perm)
    @ccall libhsl.ma57_enquire_perm_s(control::Ptr{ma57_control{Float32}},
                                      factors::Ptr{Ptr{Cvoid}}, perm::Ptr{Cint})::Cvoid
end

function ma57_enquire_pivots_s(control, factors, pivots)
    @ccall libhsl.ma57_enquire_pivots_s(control::Ptr{ma57_control{Float32}},
                                        factors::Ptr{Ptr{Cvoid}}, pivots::Ptr{Cint})::Cvoid
end
...
function ma57_part_solve_s(factors, control, part, nrhs, x, info)
    @ccall libhsl.ma57_part_solve_s(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float32}},
                                    part::Cchar, nrhs::Cint, x::Ptr{Float32},
                                    info::Ptr{Cint})::Cvoid
end

function ma57_sparse_lsolve_s(factors, control, nzrhs, irhs, nzsoln, isoln, x, sinfo)
    @ccall libhsl.ma57_sparse_lsolve_s(factors::Ptr{Ptr{Cvoid}},
                                       control::Ptr{ma57_control{Float32}}, nzrhs::Cint,
                                       irhs::Ptr{Cint}, nzsoln::Ptr{Cint}, isoln::Ptr{Cint},
                                       x::Ptr{Float32},
                                       sinfo::Ptr{ma57_sinfo{Float32}})::Cvoid
end
...
function ma57_lmultiply_s(factors, control, trans, x, y, sinfo)
    @ccall libhsl.ma57_lmultiply_s(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float32}},
                                   trans::Cchar, x::Ptr{Float32},
                                   y::Ptr{Float32}, sinfo::Ptr{ma57_sinfo{Float32}})::Cvoid
end

function ma57_get_factors_s(factors, control, nzl, iptrl, lrows, lvals, nzd, iptrd, drows,
                            dvals, perm, invperm, scale, sinfo)
    @ccall libhsl.ma57_get_factors_s(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float32}},
                                     nzl::Ptr{Cint}, iptrl::Ptr{Cint}, lrows::Ptr{Cint},
                                     lvals::Ptr{Float32}, nzd::Ptr{Cint},
                                     iptrd::Ptr{Cint}, drows::Ptr{Cint},
                                     dvals::Ptr{Float32}, perm::Ptr{Cint},
                                     invperm::Ptr{Cint}, scale::Ptr{Float32},
                                     sinfo::Ptr{ma57_sinfo{Float32}})::Cvoid
end

function ma57_default_control_d(control)
    @ccall libhsl.ma57_default_control_d(control::Ptr{ma57_control{Float64}})::Cvoid
end
...
function ma57_analyse_d(n, ne, row, col, factors, control, ainfo, perm)
    @ccall libhsl.ma57_analyse_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                 factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float64}},
                                 ainfo::Ptr{ma57_ainfo{Float64}}, perm::Ptr{Cint})::Cvoid
end
...
function ma57_factorize_d(n, ne, row, col, val, factors, control, finfo)
    @ccall libhsl.ma57_factorize_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                                   ...
                                   control::Ptr{ma57_control{Float64}},
                                   finfo::Ptr{ma57_finfo{Float64}})::Cvoid
end

function ma57_solve_d(n, ne, row, col, val, factors, nrhs, x, control, sinfo, rhs, iter,
                      cond)
    @ccall libhsl.ma57_solve_d(n::Cint, ne::Cint, row::Ptr{Cint}, col::Ptr{Cint},
                               val::Ptr{Float64}, factors::Ptr{Ptr{Cvoid}},
                               nrhs::Cint, x::Ptr{Float64},
                               control::Ptr{ma57_control{Float64}}, sinfo::Ptr{ma57_sinfo{Float64}},
                               rhs::Ptr{Float64}, iter::Cint, cond::Cint)::Cvoid
end

function ma57_finalize_d(factors, control, info)
    @ccall libhsl.ma57_finalize_d(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float64}},
                                  info::Ptr{Cint})::Cvoid
end

function ma57_enquire_perm_d(control, factors, perm)
    @ccall libhsl.ma57_enquire_perm_d(control::Ptr{ma57_control{Float64}},
                                      factors::Ptr{Ptr{Cvoid}}, perm::Ptr{Cint})::Cvoid
end

function ma57_enquire_pivots_d(control, factors, pivots)
    @ccall libhsl.ma57_enquire_pivots_d(control::Ptr{ma57_control{Float64}},
                                        factors::Ptr{Ptr{Cvoid}}, pivots::Ptr{Cint})::Cvoid
end
...
function ma57_part_solve_d(factors, control, part, nrhs, x, info)
    @ccall libhsl.ma57_part_solve_d(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float64}},
                                    part::Cchar, nrhs::Cint, x::Ptr{Float64},
                                    info::Ptr{Cint})::Cvoid
end

function ma57_sparse_lsolve_d(factors, control, nzrhs, irhs, nzsoln, isoln, x, sinfo)
    @ccall libhsl.ma57_sparse_lsolve_d(factors::Ptr{Ptr{Cvoid}},
                                       control::Ptr{ma57_control{Float64}}, nzrhs::Cint,
                                       irhs::Ptr{Cint}, nzsoln::Ptr{Cint}, isoln::Ptr{Cint},
                                       x::Ptr{Float64},
                                       sinfo::Ptr{ma57_sinfo{Float64}})::Cvoid
end
...
function ma57_lmultiply_d(factors, control, trans, x, y, sinfo)
    @ccall libhsl.ma57_lmultiply_d(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float64}},
                                   trans::Cchar, x::Ptr{Float64},
                                   y::Ptr{Float64}, sinfo::Ptr{ma57_sinfo{Float64}})::Cvoid
end

function ma57_get_factors_d(factors, control, nzl, iptrl, lrows, lvals, nzd, iptrd, drows,
                            dvals, perm, invperm, scale, sinfo)
    @ccall libhsl.ma57_get_factors_d(factors::Ptr{Ptr{Cvoid}}, control::Ptr{ma57_control{Float64}},
                                     nzl::Ptr{Cint}, iptrl::Ptr{Cint}, lrows::Ptr{Cint},
                                     lvals::Ptr{Float64}, nzd::Ptr{Cint},
                                     iptrd::Ptr{Cint}, drows::Ptr{Cint},
                                     dvals::Ptr{Float64}, perm::Ptr{Cint},
