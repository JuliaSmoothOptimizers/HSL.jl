...
function mf36bd(n, ind, fmtind, lunit)
  @ccall libhsl.mf36bd_(n::Ref{Cint}, ind::Ptr{Cint}, fmtind::Ptr{UInt8}, lunit::Ref{Cint})::Cvoid
end

function mf36cd(n, a, fmta, lunit)
  @ccall libhsl.mf36cd_(n::Ref{Cint}, a::Ptr{ComplexF64}, fmta::Ptr{UInt8}, lunit::Ref{Cint})::Cvoid
end
...
function mf36b(n, ind, fmtind, lunit)
  @ccall libhsl.mf36b_(n::Ref{Cint}, ind::Ptr{Cint}, fmtind::Ptr{UInt8}, lunit::Ref{Cint})::Cvoid
end

function mf36c(n, a, fmta, lunit)
  @ccall libhsl.mf36c_(n::Ref{Cint}, a::Ptr{ComplexF32}, fmta::Ptr{UInt8}, lunit::Ref{Cint})::Cvoid
end
