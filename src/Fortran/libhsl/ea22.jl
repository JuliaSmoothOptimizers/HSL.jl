...
function ea22ad(n, numeig, numcol, eps, x, nx, d, u, w, lw, iw, kmult, ipos, icntl, keep, rkeep)
  @ccall libhsl.ea22ad_(n::Ref{Cint}, numeig::Ref{Cint}, numcol::Ref{Cint}, eps::Ref{Float64},
                        x::Ptr{Float64}, nx::Ref{Cint}, d::Ptr{Float64}, u::Ptr{Float64},
                        w::Ptr{Float64}, lw::Ref{Cint}, iw::Ptr{Cint}, kmult::Ref{Cint},
                        ipos::Ref{Cint}, icntl::Ptr{Cint}, keep::Ptr{Cint},
...
function ea22bd(n, g, p, eps, x, nx, d, u, w, b, q, v, r, kmult, ipos, icntl, keep, rkeep)
  @ccall libhsl.ea22bd_(n::Ref{Cint}, g::Ref{Cint}, p::Ref{Cint}, eps::Ref{Float64},
                        x::Ptr{Float64}, nx::Ref{Cint}, d::Ptr{Float64}, u::Ptr{Float64},
                        w::Ptr{Float64}, b::Ptr{Float64}, q::Ptr{Float64}, v::Ptr{Float64},
...
function ea22ed(k, n, x, nx, ipos, iseed)
  @ccall libhsl.ea22ed_(k::Ref{Cint}, n::Ref{Cint}, x::Ptr{Float64}, nx::Ref{Cint}, ipos::Ref{Cint},
...
function ea22fd(n, a, nd, d, v, eigvec, irot, iw)
  @ccall libhsl.ea22fd_(n::Ref{Cint}, a::Ptr{Float64}, nd::Ref{Cint}, d::Ptr{Float64},
                        v::Ptr{Float64}, eigvec::Ref{Cint}, irot::Ref{Cint}, iw::Ptr{Cint})::Cvoid
end
...
function ea22a(n, numeig, numcol, eps, x, nx, d, u, w, lw, iw, kmult, ipos, icntl, keep, rkeep)
  @ccall libhsl.ea22a_(n::Ref{Cint}, numeig::Ref{Cint}, numcol::Ref{Cint}, eps::Ref{Float32},
                       x::Ptr{Float32}, nx::Ref{Cint}, d::Ptr{Float32}, u::Ptr{Float32},
                       w::Ptr{Float32}, lw::Ref{Cint}, iw::Ptr{Cint}, kmult::Ref{Cint},
                       ipos::Ref{Cint}, icntl::Ptr{Cint}, keep::Ptr{Cint},
                       rkeep::Ptr{Float32})::Cvoid
end

function ea22b(n, g, p, eps, x, nx, d, u, w, b, q, v, r, kmult, ipos, icntl, keep, rkeep)
  @ccall libhsl.ea22b_(n::Ref{Cint}, g::Ref{Cint}, p::Ref{Cint}, eps::Ref{Float32}, x::Ptr{Float32},
                       nx::Ref{Cint}, d::Ptr{Float32}, u::Ptr{Float32}, w::Ptr{Float32},
                       b::Ptr{Float32}, q::Ptr{Float32}, v::Ptr{Float32}, r::Ptr{Cint},
                       kmult::Ref{Cint}, ipos::Ref{Cint}, icntl::Ptr{Cint}, keep::Ptr{Cint},
                       rkeep::Ptr{Float32})::Cvoid
end

function ea22e(k, n, x, nx, ipos, iseed)
  @ccall libhsl.ea22e_(k::Ref{Cint}, n::Ref{Cint}, x::Ptr{Float32}, nx::Ref{Cint}, ipos::Ref{Cint},
                       iseed::Ref{Cint})::Cvoid
end

function ea22f(n, a, nd, d, v, eigvec, irot, iw)
  @ccall libhsl.ea22f_(n::Ref{Cint}, a::Ptr{Float32}, nd::Ref{Cint}, d::Ptr{Float32},
                       v::Ptr{Float32}, eigvec::Ref{Cint}, irot::Ref{Cint}, iw::Ptr{Cint})::Cvoid
end
