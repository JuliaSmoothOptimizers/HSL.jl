function me50ad(m, n, ne, la, a, irn, jcn, iq, cntl, icntl, ip, np, jfirst, lenr, lastr,
...
function me50bd(m, n, ne, job, aa, irna, iptra, cntl, icntl, ip, iq, np, lfact, fact, irnf,
                iptrl, iptru, w, iw, info, rinfo)
    @ccall libhsl.me50bd_(m::Ref{Cint}, n::Ref{Cint}, ne::Ref{Cint}, job::Ref{Cint},
                          aa::Ptr{ComplexF64}, irna::Ptr{Cint}, iptra::Ptr{Cint},
                          cntl::Ptr{Float64}, icntl::Ptr{Cint}, ip::Ptr{Cint},
                          iq::Ptr{Cint}, np::Ref{Cint}, lfact::Ref{Cint},
                          fact::Ptr{ComplexF64}, irnf::Ptr{Cint}, iptrl::Ptr{Cint},
                          iptru::Ptr{Cint}, w::Ptr{ComplexF64}, iw::Ptr{Cint},
                          info::Ptr{Cint}, rinfo::Ref{Float64})::Cvoid
end

function me50cd(m, n, icntl, iq, np, kind, lfact, fact, irnf, iptrl, iptru, b, x, w, info)
    @ccall libhsl.me50cd_(m::Ref{Cint}, n::Ref{Cint}, icntl::Ptr{Cint}, iq::Ptr{Cint},
                          np::Ref{Cint}, kind::Ref{Cint}, lfact::Ref{Cint},
                          fact::Ptr{ComplexF64}, irnf::Ptr{Cint}, iptrl::Ptr{Cint},
                          iptru::Ptr{Cint}, b::Ptr{ComplexF64}, x::Ptr{ComplexF64},
                          w::Ptr{ComplexF64}, info::Ptr{Cint})::Cvoid
end

function me50dd(la, a, ind, iptr, n, disp, reals)
    @ccall libhsl.me50dd_(la::Ref{Cint}, a::Ptr{ComplexF64}, ind::Ptr{Cint},
                          iptr::Ptr{Cint}, n::Ref{Cint}, disp::Ref{Cint},
...
function me50a(m, n, ne, la, a, irn, jcn, iq, cntl, icntl, ip, np, jfirst, lenr, lastr,
               nextr, iw, ifirst, lenc, lastc, nextc, info, rinfo)
    @ccall libhsl.me50a_(m::Ref{Cint}, n::Ref{Cint}, ne::Ref{Cint}, la::Ref{Cint},
                         a::Ptr{ComplexF32}, irn::Ptr{Cint}, jcn::Ptr{Cint}, iq::Ptr{Cint},
...
function me50b(m, n, ne, job, aa, irna, iptra, cntl, icntl, ip, iq, np, lfact, fact, irnf,
               iptrl, iptru, w, iw, info, rinfo)
    @ccall libhsl.me50b_(m::Ref{Cint}, n::Ref{Cint}, ne::Ref{Cint}, job::Ref{Cint},
                         aa::Ptr{ComplexF32}, irna::Ptr{Cint}, iptra::Ptr{Cint},
                         cntl::Ptr{Float32}, icntl::Ptr{Cint}, ip::Ptr{Cint}, iq::Ptr{Cint},
                         np::Ref{Cint}, lfact::Ref{Cint}, fact::Ptr{ComplexF32},
...
function me50c(m, n, icntl, iq, np, kind, lfact, fact, irnf, iptrl, iptru, b, x, w, info)
    @ccall libhsl.me50c_(m::Ref{Cint}, n::Ref{Cint}, icntl::Ptr{Cint}, iq::Ptr{Cint},
                         np::Ref{Cint}, kind::Ref{Cint}, lfact::Ref{Cint},
                         fact::Ptr{ComplexF32}, irnf::Ptr{Cint}, iptrl::Ptr{Cint},
                         iptru::Ptr{Cint}, b::Ptr{ComplexF32}, x::Ptr{ComplexF32},
