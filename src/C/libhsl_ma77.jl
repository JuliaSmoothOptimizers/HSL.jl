...
function ma77_default_control_s(control)
  @ccall libhsl_ma77.ma77_default_control_s(control::Ref{ma77_control{Float32}})::Cvoid
end
...
function ma77_open_nelt_s(n, fname1, fname2, fname3, fname4, keep, control, info, nelt)
  @ccall libhsl_ma77.ma77_open_nelt_s(n::Cint, fname1::Ptr{Cchar}, fname2::Ptr{Cchar},
                                      fname3::Ptr{Cchar}, fname4::Ptr{Cchar}, keep::Ptr{Ptr{Cvoid}},
...
function ma77_open_s(n, fname1, fname2, fname3, fname4, keep, control, info)
  @ccall libhsl_ma77.ma77_open_s(n::Cint, fname1::Ptr{Cchar}, fname2::Ptr{Cchar},
                                 fname3::Ptr{Cchar}, fname4::Ptr{Cchar}, keep::Ptr{Ptr{Cvoid}},
...
function ma77_input_vars_s(idx, nvar, list, keep, control, info)
  @ccall libhsl_ma77.ma77_input_vars_s(idx::Cint, nvar::Cint, list::Ptr{Cint},
...
function ma77_input_reals_s(idx, length, reals, keep, control, info)
  @ccall libhsl_ma77.ma77_input_reals_s(idx::Cint, length::Cint, reals::Ptr{Float32},
                                        keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float32}},
                                        info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_analyse_s(order, keep, control, info)
  @ccall libhsl_ma77.ma77_analyse_s(order::Ptr{Cint}, keep::Ptr{Ptr{Cvoid}},
                                    control::Ref{ma77_control{Float32}}, info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_factor_s(posdef, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_factor_s(posdef::Cint, keep::Ptr{Ptr{Cvoid}},
                                   control::Ref{ma77_control{Float32}}, info::Ref{ma77_info{Float32}},
                                   scale::Ptr{Float32})::Cvoid
end

function ma77_factor_solve_s(posdef, keep, control, info, scale, nrhs, lx, rhs)
  @ccall libhsl_ma77.ma77_factor_solve_s(posdef::Cint, keep::Ptr{Ptr{Cvoid}},
                                         control::Ref{ma77_control{Float32}}, info::Ref{ma77_info{Float32}},
...
function ma77_solve_s(job, nrhs, lx, x, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_solve_s(job::Cint, nrhs::Cint, lx::Cint, x::Ptr{Float32},
                                  keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float32}},
...
function ma77_resid_s(nrhs, lx, x, lresid, resid, keep, control, info, anorm_bnd)
  @ccall libhsl_ma77.ma77_resid_s(nrhs::Cint, lx::Cint, x::Ptr{Float32}, lresid::Cint,
...
function ma77_scale_s(scale, keep, control, info, anorm)
  @ccall libhsl_ma77.ma77_scale_s(scale::Ptr{Float32}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma77_control{Float32}}, info::Ref{ma77_info{Float32}},
                                  anorm::Ptr{Float32})::Cvoid
end

function ma77_enquire_posdef_s(d, keep, control, info)
  @ccall libhsl_ma77.ma77_enquire_posdef_s(d::Ptr{Float32}, keep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma77_control{Float32}},
                                           info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_enquire_indef_s(piv_order, d, keep, control, info)
  @ccall libhsl_ma77.ma77_enquire_indef_s(piv_order::Ptr{Cint}, d::Ptr{Float32},
                                          keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float32}},
                                          info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_alter_s(d, keep, control, info)
  @ccall libhsl_ma77.ma77_alter_s(d::Ptr{Float32}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma77_control{Float32}}, info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_restart_s(restart_file, fname1, fname2, fname3, fname4, keep, control, info)
  @ccall libhsl_ma77.ma77_restart_s(restart_file::Ptr{Cchar}, fname1::Ptr{Cchar},
                                    fname2::Ptr{Cchar}, fname3::Ptr{Cchar}, fname4::Ptr{Cchar},
                                    keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float32}},
                                    info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_finalise_s(keep, control, info)
  @ccall libhsl_ma77.ma77_finalise_s(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float32}},
                                     info::Ref{ma77_info{Float32}})::Cvoid
end

function ma77_solve_fredholm_s(nrhs, flag_out, lx, x, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_solve_fredholm_s(nrhs::Cint, flag_out::Ptr{Cint}, lx::Cint,
...
function ma77_lmultiply_s(trans, k, lx, x, ly, y, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_lmultiply_s(trans::Cint, k::Cint, lx::Cint, x::Ptr{Float32},
...
function ma77_default_control_d(control)
  @ccall libhsl_ma77.ma77_default_control_d(control::Ref{ma77_control{Float64}})::Cvoid
end

function ma77_open_nelt_d(n, fname1, fname2, fname3, fname4, keep, control, info, nelt)
  @ccall libhsl_ma77.ma77_open_nelt_d(n::Cint, fname1::Ptr{Cchar}, fname2::Ptr{Cchar},
                                      fname3::Ptr{Cchar}, fname4::Ptr{Cchar}, keep::Ptr{Ptr{Cvoid}},
...
function ma77_open_d(n, fname1, fname2, fname3, fname4, keep, control, info)
  @ccall libhsl_ma77.ma77_open_d(n::Cint, fname1::Ptr{Cchar}, fname2::Ptr{Cchar},
                                 fname3::Ptr{Cchar}, fname4::Ptr{Cchar}, keep::Ptr{Ptr{Cvoid}},
...
function ma77_input_vars_d(idx, nvar, list, keep, control, info)
  @ccall libhsl_ma77.ma77_input_vars_d(idx::Cint, nvar::Cint, list::Ptr{Cint},
...
function ma77_input_reals_d(idx, length, reals, keep, control, info)
  @ccall libhsl_ma77.ma77_input_reals_d(idx::Cint, length::Cint, reals::Ptr{Float64},
                                        keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float64}},
                                        info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_analyse_d(order, keep, control, info)
  @ccall libhsl_ma77.ma77_analyse_d(order::Ptr{Cint}, keep::Ptr{Ptr{Cvoid}},
                                    control::Ref{ma77_control{Float64}}, info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_factor_d(posdef, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_factor_d(posdef::Cint, keep::Ptr{Ptr{Cvoid}},
                                   control::Ref{ma77_control{Float64}}, info::Ref{ma77_info{Float64}},
                                   scale::Ptr{Float64})::Cvoid
end

function ma77_factor_solve_d(posdef, keep, control, info, scale, nrhs, lx, rhs)
  @ccall libhsl_ma77.ma77_factor_solve_d(posdef::Cint, keep::Ptr{Ptr{Cvoid}},
                                         control::Ref{ma77_control{Float64}}, info::Ref{ma77_info{Float64}},
...
function ma77_solve_d(job, nrhs, lx, x, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_solve_d(job::Cint, nrhs::Cint, lx::Cint, x::Ptr{Float64},
                                  keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float64}},
...
function ma77_resid_d(nrhs, lx, x, lresid, resid, keep, control, info, anorm_bnd)
  @ccall libhsl_ma77.ma77_resid_d(nrhs::Cint, lx::Cint, x::Ptr{Float64}, lresid::Cint,
...
function ma77_scale_d(scale, keep, control, info, anorm)
  @ccall libhsl_ma77.ma77_scale_d(scale::Ptr{Float64}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma77_control{Float64}}, info::Ref{ma77_info{Float64}},
                                  anorm::Ptr{Float64})::Cvoid
end

function ma77_enquire_posdef_d(d, keep, control, info)
  @ccall libhsl_ma77.ma77_enquire_posdef_d(d::Ptr{Float64}, keep::Ptr{Ptr{Cvoid}},
                                           control::Ref{ma77_control{Float64}},
                                           info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_enquire_indef_d(piv_order, d, keep, control, info)
  @ccall libhsl_ma77.ma77_enquire_indef_d(piv_order::Ptr{Cint}, d::Ptr{Float64},
                                          keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float64}},
                                          info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_alter_d(d, keep, control, info)
  @ccall libhsl_ma77.ma77_alter_d(d::Ptr{Float64}, keep::Ptr{Ptr{Cvoid}},
                                  control::Ref{ma77_control{Float64}}, info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_restart_d(restart_file, fname1, fname2, fname3, fname4, keep, control, info)
  @ccall libhsl_ma77.ma77_restart_d(restart_file::Ptr{Cchar}, fname1::Ptr{Cchar},
                                    fname2::Ptr{Cchar}, fname3::Ptr{Cchar}, fname4::Ptr{Cchar},
                                    keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float64}},
                                    info::Ref{ma77_info{Float64}})::Cvoid
end
...
function ma77_finalise_d(keep, control, info)
  @ccall libhsl_ma77.ma77_finalise_d(keep::Ptr{Ptr{Cvoid}}, control::Ref{ma77_control{Float64}},
                                     info::Ref{ma77_info{Float64}})::Cvoid
end

function ma77_solve_fredholm_d(nrhs, flag_out, lx, x, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_solve_fredholm_d(nrhs::Cint, flag_out::Ptr{Cint}, lx::Cint,
...
function ma77_lmultiply_d(trans, k, lx, x, ly, y, keep, control, info, scale)
  @ccall libhsl_ma77.ma77_lmultiply_d(trans::Cint, k::Cint, lx::Cint, x::Ptr{Float64},
